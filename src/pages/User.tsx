...
import { BASKET_ROUTE, CATALOG_ROUTE, HOME_ROUTE } from '../utils/routs';
...
const User = () => {
    ...
    const [secondName, setsecondName] = useState(user.user.sername)
    const [mail, setmail] = useState(user.user.email)
    const [tell, settell] = useState(user.user.tell)
