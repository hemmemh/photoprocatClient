...
import { type IBrand } from '../../../utils/interfaces'
                    ...
                    >
                        { brands.map((brand: IBrand) =>
                            <SwiperSlide key={brand._id}>
                                <div onClick={async () => { await dispatch(chooseBrand(brand._id)) }} className={checkedBrands.includes(brand._id) ? 'slider-brand-catalog__item item-slider-brand-catalog active' : 'slider-brand-catalog__item item-slider-brand-catalog'}>
                ...
                <div className="slider-brand-catalog__spoiler">
                    <ProductSpoiler changeName={false} className='brand' >
                        ...
                        <div className="mobile-item-slider-brand-catalog__cover">
                            {brands.map((brand: IBrand) =>
                                <div key={brand.name} onClick={async () => { await dispatch(chooseBrand(brand._id)) }} className={checkedBrands.includes(brand._id) ? 'slider-brand-catalog__item-mobile mobile-item-slider-brand-catalog active' : 'slider-brand-catalog__item-mobile mobile-item-slider-brand-catalog'}>
