...
const ModalRaiting = () => {
    ...
    const dispatchModal = (e: boolean) => {
        dispatch(setModal(e))
    }

    return (
        <Modal active={modal} setActive={dispatchModal} modalClass='raiting'>
            <div className="RaitingModal">
                ...
                <div className="RaitingModal__text">
                    <MyTextArea value={text} setValue={settext} placeholder='отзыв' className='RaitingModal__textarea'/>
                </div>
