  ...
  return (
    <div className="main-product__info info-product">
        ...
        <div className="main-product__actions">
            ...
            <Button2 onClick={addToBasket} ripple={true} className={inBasketSnippet ? 'buttonCart  active ': 'buttonCart'} >{!basketLoader ? <Loader className={'basketLoaderProduct'} /> : <CartSvg/>}{inBasket ? 'В корзине' : 'В корзину'}</Button2>
        </div>
