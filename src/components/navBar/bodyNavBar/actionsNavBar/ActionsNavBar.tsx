...
const ActionsNavBar = () => {
  ...
  return (
    ...
    <div onClick={()=>navigate(LOVES_ROUTE)} className="actionsMenu__action _icon-star">{navbar.loves !== 0 && <span className='actionsMenu__span _loves'>{navbar.loves}</span> }</div>
